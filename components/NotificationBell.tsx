  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        {unread.length > 0 && (
          <span
            className="absolute -top-0.5 -right-0.5 min-w-4 h-4 px-1 rounded-full flex items-center justify-center text-xs font-black"
            style={{
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                background:
                  "linear-gradient(135deg, var(--color-secondary), var(--color-dark))",
              }}
            >
              ...
              {notifications.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-10 px-4 text-center">
                  ...
                  <p className="text-xs mt-1" style={{ color: "#9CA3AF" }}>
                    We&apos;ll notify you when your request status changes.
                  </p>
                </div>
              ) : (
                    ...
                    <div className="flex-1 min-w-0">
                      {n.request && (
                        <p
                          ...
                          style={{
                            color:
                              TYPE_COLOR[n.type] ?? "var(--color-secondary)",
                          }}
                        >
                          {n.request.documentType.name} · Queue #
                          {n.request.queueNumber}
                        </p>
                      )}
                      <p
